...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:BERG BOT\n'
            + 'ORG:Owner BERG BOT;\n'
            + 'TEL;type=CELL;type=VOICE;waid=55083993462143:+55 083 99346 2143\n'
            + 'END:VCARD'
       
const vcard1 = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + 'FN:Bergnz\n'
            + 'ORG:Co Owner Berg 𝙱𝙾𝚃;\n'
            + 'TEL;type=CELL;type=VOICE;waid=55083993462143:+55 083 99346 2143\n'
            + 'END:VCARD'

prefix = "!"
name = "Bergbot"
rdaftar = "OBRIGADO POR SE REGISTAR PARA SER UM USUÁRIO DO Bergbot 😁"
rmenu = "Oi amigo Bergbot 👋🏻 NÃO SE ESQUEÇA NAO PAGUE POR BOTS:)"
botinfo = "PARA BOTS CONVIDADOS, TODOS BOTS TERMUX SAO INDONÉSIO NENHUM BR CRIA SÓ EDITA:)"
limitt = 999999999
memberLimit = 2
ban = []
premium = ["55083993462143@s.whatsapp.net","55083993462143@s.whatsapp.net"]
...
async function starts() {
	...
	denz.on('connecting', () => {
		start('2', 'conectando com berg bot ❤️...')
	})
	denz.on('open', () => {
...
ᴅɪɢɪᴛᴇ ${prefix}daftar ᴘᴀʀᴀ ᴄᴏᴍᴇᴄᴀʀ ᴀ ᴜsᴀʀ  ʙᴏᴛ`
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["55083993462143@s.whatsapp.net","55083993462143@s.whatsapp.net","55083993462143@s.whatsapp.net"] // owner number ubah aja
...
case 'husbu':
		...
		if (budy.includes(`Thanks`)) {
                  ...
                  if (budy.includes(`thanks`)) {
                  reply(`ꜱᴀᴍᴀ-ꜱᴀᴍᴀ ᴋᴀᴋ *${pushname2}*, BERG SAUDADES >-<`)
                  }
                  if (budy.includes(`makasih`)) {
                  reply(`ꜱᴀᴍᴀ-ꜱᴀᴍᴀ ᴋᴀᴋ *${pushname2}*, BERG SAUDADES >-<`)
                  }
                  ...
                  reply(`IAE MENO *${pushname2}*, BERG PODE TE AJUDAR? DIGITE *${prefix}menu* ʏᴀ ᴋᴀᴋ`)
                  }
			      if (budy.includes(`Dns`)) {
                  reply(`IAE MENO *${pushname2}*, BERG PODE TE AJUDAR? DIGITE *${prefix}menu* ʏᴀ ᴋᴀᴋ`)
                  }
